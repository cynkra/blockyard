...
func EnableApp(srv *server.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if r.Header.Get("HX-Request") != "" {
			w.Header().Set("HX-Trigger", `{"appEnabled":"","showToast":{"message":"App enabled","type":"success"}}`)
		}
...
func DisableApp(srv *server.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if r.Header.Get("HX-Request") != "" {
			w.Header().Set("HX-Trigger", `{"appDisabled":"","showToast":{"message":"App disabled","type":"success"}}`)
		}
