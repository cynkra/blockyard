...
// MakeBundle returns a valid tar.gz containing app.R and a DESCRIPTION file.
// The DESCRIPTION makes the bundle deployable without bare-script preprocessing.
